...
**iam Durga Prasad A** 20-year-old Full-Stack Developer specializing in **React Native** and **Machine Learning**. With a passion for building secure, outcome-driven engineering solutions, focuses on creating applications that bridge the gap between complex cryptography and intuitive user experiences.
